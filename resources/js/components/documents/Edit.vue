[24-Nov-2021] - Logical Error on Datepicker value binding. 
                  ...
                  <div class="form-group mt-2">
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-2">
                        <button
                          type="button"
                          class="btn btn-secondary form-control px-1 ml-1"
...
export default {
  ...
  created() {
    ...
    this.optionsFor_From();
  },
  mounted() {
    // this.cc.values = this.copy;
  },
  methods: {
    getDocument() {
      axios
        ...
        .then((result) => {
          ...
          this.from.values = result.data.data.from;
          this.to.values = result.data.data.to.split("|");
          this.cc.values = result.data.data.cc.split("|");
          this.attn.values = result.data.data.attn.split("|");
          this.staffs.values = result.data.data.staffs.split("|");
          this.staffs.options = result.data.data.staffs.split("|");
          this.form.date_issued = new Date(result.data.data.date_issued);
          
          if (result.data.data.for_secretary === "1") {
            this.form.for_secretary = true;
          }
    ...
    updateDocument() {
      // if (this.form.save_draft === true) {
      //   this.doc_status = "Draft";
      // } else {
      //   this.doc_status = "Final";
      // }
      axios
        .put("/api/documents/" + this.$route.params.id, {
