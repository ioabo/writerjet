  ...
  <main>
    <div class="container-fluid px-4">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <div v-if="empty_documents === true">
            <h3>No records found!</h3>
          </div>
          <div v-else>
            <table
              class="table table-hover table-secondary table-borderless"
            >
              ...
              <tbody>
                <tr v-for="document in documents" :key="document.id">
                  ...
                  <td>
                    <div v-if="document.status === 'Draft'">
                      <!-- <td> -->
                      <button
                        type="button"
                    ...
                    <div v-else-if="document.status === 'Final'">
                      <!-- <td> -->
                      <a
  ...
  methods: {
    getDocuments() {
      axios
        ...
        .then((result) => {
          ...
          this.empty_documents = result.data.empty_documents;
        })
        .catch((error) => {
    ...
    getThisDocument(id) {
      axios
        ...
        .then((result) => {
          this.select_doc = result.data.data;
          console.log(this.select_doc.pdf_url);
        })
        .catch((error) => {
          console.log(console.error);
        });
    ...
    downloadPDF(id) {
      // this.getThisDocument(id);
      axios.get("/dompdf/" + id + "/download").catch((error) => {
        console.log(console.error);
      });
    },
    createDocument() {
