...
@section('content')
    <div class="container-fluid">
        <h3 class="mt-4">Edit Template</h1>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    <div class="col">{{ __('Edit Template Form') }}</div>
                ...
                <form method="POST" action="{{ route('subjects.update', $subject->id) }}">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input id="category_id" type="category_id" class="form-control" name="category_id"
                            value="{{ old('category_id', $subject->category_id) }}" required
                            placeholder="name@example.com" readonly hidden>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name"
                            value="{{ old('name', $subject->name) }}" required placeholder="name@example.com" autofocus
                            autocomplete="off">
        ...
        <div class="m-2 p-2">
            <form method="POST" action="{{ route('subjects.destroy', $subject->id) }}">
                @csrf
                @method('DELETE')
                <button class="btn btn-danger">Delete {{ $subject->name }}
            </form>
        </div>
    </div>
