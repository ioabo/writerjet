...
@section('content')
    <div class="container-fluid">
        <h4 class="mt-4">Add New Division</h4>
        <div class="breadcrumb mt-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-2">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a
                            href="{{ route('divisions.index', $ministry->id) }}">{{ $ministry->code }}
                            Divisions</a>
                    </li>
        ...
        <div class="card border-1 mt-4">
            <div class="card-header">
                <div class="row">
                    <div class="row">
                        <div class="col">{{ __('Create Division for '.$ministry->code) }}</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('divisions.store', $ministry->id) }}">
                    @csrf
